...
const EventData = (props) => {
  ...
  return (
    <div className={"col-lg-4 seesion-card " + postTopicName}>
      <div className="card activity-card shadow mb-3" style={{ width: "100%", height: "500px" }}>
        ...
        <div className="card-body event-body">
          <div className="view-session d-flex justify-content-between py-1">
            ...
            <div>
              <small className="card-text profile-text"><b>Time :</b> {postTime}</small>
            </div>
          </div>
          <a className="view-data mt-4" data-toggle="modal" data-target={"#" + id}>
            <h4 className="card-title event-post-title">{postTopicName}</h4>
            <hr className='my-2' />
            <p className="post-discription activity-discription card-text">{parse(`${postLongDetail.substring(0, 50)}`)}</p>
          </a>
          <div className="view-session d-flex justify-content-between pb-3">
            <div className="user-profile-data">
