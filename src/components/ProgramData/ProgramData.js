      ...
      <div className="card activity-card1 shadow mb-3" style={{ width: "100%" }}>
        ...
        <div className="card-body event-body">
          <div className='d-flex justify-content-between'>
            ...
            <small className="card-text profile-text"><b>Age :</b> {postAge}</small>
          </div>
          <a className="view-data" data-toggle="modal" data-target={"#" + id}>
            <h4 className="card-title event-post-title mt-3">{postTopicName}</h4>
            <hr className='my-2' />
            <p className="post-discription activity-discription card-text">{parse(`${postLongDetail.substring(0, 100)}...`)}</p>
          </a>
          <div className="view-session d-flex justify-content-between py-2">
