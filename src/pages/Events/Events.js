...
function Events(props) {
    ...
    const getPostData = () => {
        // Axios
        // .get(`https://safari-kids-dashboard-default-rtdb.firebaseio.com/event.json`)
                        ...
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                <form onSubmit={handleUpload}>
                                    ...
                                    <div className="form-group">
                                        <label for="topic">Event Topic Name</label>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <CKEditor
                                            ...
                                            onChange={(event, editor) => {
                                                ...
                                                setPostLongDescription(modifiedData);
                        ...
                        <div className="col-lg-11">
                            ...
                            <div className="form-row">
                                <div className="form-group col-md-11">
                                    <label for="inputEmail4">Search based on Event Name</label>
