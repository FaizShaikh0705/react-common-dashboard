            ...
            file =>
                new Promise((resolve, reject) => {
                    ...
                    let uploadTask = storage
                        .child(`/images/ProgramData/${file.name}`)
                        .put(file, metadata);
                    uploadTask.on(
...
function Programs() {
    ...
    function handleUpload(e) {
        ...
        const uploadTask = storage.ref(`/images/program/${time + "_" + file.name}`).put(file);
    ...
    const getPostData = () => {
        // Axios
        // .get(`https://safari-kids-dashboard-default-rtdb.firebaseio.com/program.json`)
        firebase.database().ref(`program`).get()
            .then((response) => {
    ...
    const handleAddPostData = (e) => {
        ...
        if (postPositions.current.value.length === 0 || postTopics.current.value.length === 0) {
            ...
            if (editDetails) {
                ...
                firebase.database().ref(`program/${postId}`).set(
                    {
            ...
            //  if user wants to add a new card
                ...
                firebase.database().ref('program/').push(
                    {
    ...
    const handleEdit = (
        ...
        setEditAge(editedAge);
    };

    // handles archive on card archive click
    const handleDelete = (postId, e) => {
        if (window.confirm("Are you sure you want to delete the Program?")) {
            // Axios
            // .delete(`https://educaretech-dashboard-default-rtdb.firebaseio.com/SessionData/${postId}.json`)
            firebase.database().ref(`program/${postId}`).remove()
                .then((response) => {
                    alert("Program deleted succesfully");
                    window.location.reload();
                    ...
                    <div className="modal-dialog modal-lg" role="document">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title" id="exampleModalLabel">{editDetails ? "Edit Program" : "Add Program"}</h5>
                            ...
                            <div className="modal-body">
                                <form onSubmit={handleUpload}>
                                    ...
                                    <div className="form-group">
                                        <label for="topic">Program Topic Name</label>
                                        <input type="text" className="form-control" id="topic"
                                            ...
                                            placeholder="Enter Program Topic Name" />
                                    </div>
                                    <div className="form-group">
                        ...
                        <div className="col-lg-11">
                            ...
                            <div className="add-teacher-profile pb-3">
                                <div className="d-flex justify-content-between">
                                    <div className="title">
                                        <h2 id="teach_profile">Programs</h2>
                            ...
                            <div className="form-row">
                                <div className="form-group col-md-11">
                                    <label for="inputEmail4">Search based on Program Name</label>
